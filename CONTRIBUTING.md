...
This outlines how to propose a change to pederlib2. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("pedersebastian/pederlib2", fork = TRUE)`.
...
Please note that the pederlib2 project is released with a [Contributor
Code of
Conduct](https://pedersebastian.github.io/pederlib2/CODE_OF_CONDUCT.md).
