...
Thanks for using pederlib2! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/pedersebastian/pederlib2/issues/new).
...
requests](https://github.com/pedersebastian/pederlib2/issues) to make
